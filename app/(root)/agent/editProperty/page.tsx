...
import { UPDATE_PROPERTY_MUTATION, GET_AGENT_PROPERTIES_QUERY } from '@/lib/graphql';
    ...
    if (propertyId) {
      ...
      if (property) {
        setFormData({
          ...
          isAttached: property.isAttached || false,
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="flex items-center space-x-2 mb-6">
              ...
              <h2 className="text-xl font-semibold text-gray-900">Pricing & Type</h2>
            </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-[#002b6d] file:text-white hover:file:bg-[#003c9a]"
                />
                {errors.photos && (
