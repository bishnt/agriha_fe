...
export default function SignInClient() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 p-4">
      <div className="w-full max-w-4xl flex flex-col lg:flex-row items-center justify-center gap-0 min-h-[500px] lg:h-[600px]">
        {/* Outer rounded box */}
        <div className="w-full bg-white/90 rounded-2xl shadow-2xl border border-white/30 flex flex-col lg:flex-row overflow-hidden h-full relative">
          ...
          {/* Left Side - Welcome Message & Social Login (Desktop) */}
          <div className="hidden lg:flex flex-col justify-center items-center text-white bg-gradient-to-br from-[#002b6d] to-[#001a42] max-w-md w-full rounded-l-2xl px-6 py-10 space-y-6">
          ...
          <div className="flex-1 w-full bg-white/90 rounded-r-2xl lg:rounded-none lg:rounded-r-2xl p-6 sm:p-8 lg:p-12 flex flex-col justify-center items-center max-w-md mx-auto lg:max-w-none">
            <div className="flex justify-center mb-6">
              <Image src="/logo.svg" alt="AGRIHA" width={56} height={56} className="h-14 w-auto" />
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6 w-full max-w-sm">
              ...
              <Button
                type="submit"
                disabled={isLoading}
                className="w-full h-12 bg-gradient-to-r from-[#002b6d] to-[#001a42] hover:from-[#001a42] hover:to-[#000d1a] text-white font-semibold rounded-lg shadow-md hover:shadow-lg transform hover:scale-[1.02] transition-all duration-300 group"
              >
            ...
            {/* Mobile Social Login */}
            <div className="block lg:hidden w-full max-w-sm mt-6">
              <div className="relative my-6 w-full flex items-center justify-center">
                <Separator className="bg-gray-200" />
                <span className="absolute bg-white px-3 text-gray-400 text-sm font-medium">or continue with</span>
              </div>
